  ...
  return (
    <div className="grid grid-flow-col p-2 m-2 shadow-lg">
      <div className="flex col-span-1">
        <img
          className="h-7 py-1 cursor-pointer"
      ...
      <div className="col-span-10 px-12">
        <div>
        <input
          className=" px-5 w-1/2 border border-gray-400 p-2 rounded rounded-l-full"
          type="text"
          placeholder="Search"
          value={searchQuery}
          ...
          />
        <button className="border border-gray-400 p-2 rounded rounded-r-full bg-gray-200">
          🔍
        </button>
        </div>
       { showSuggestion && (
